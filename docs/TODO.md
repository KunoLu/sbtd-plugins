...
| **P3** | T15–T16 入口 + 整包验收 | 🟡 T15 finish-work ✅ @ `663e0e5`；r3b+r4b CLEAN；#62 待合 |
...
| T15 | `/sbtd` 命令与 README | 🟡 | #62 `feat/t15-sbtd-command` @ `663e0e5`；product r3b CLEAN @ `f8561bf`；process r4b CLEAN @ `70d3a60`；finish-work ✅；archive implement+DDD；locks Q1A–Q6A；tests 322/322（t15 12/12）；**未合** / 未 npm |
| T16 | 端到端验收 | ⬜ | P3 |
