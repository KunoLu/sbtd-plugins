...
| **P3** | T15–T16 入口 + 整包验收 | 🟡 T15 r3 CLEAN @ `f8561bf`；finish-work 待重做；#62 待合 |
...
| T15 | `/sbtd` 命令与 README | 🟡 | #62 `feat/t15-sbtd-command` @ `f8561bf`；r3 CLEAN @ `f8561bf`（r2 @ `b7d346b` stale）；finish-work 待重做；task `in_progress`；locks Q1A–Q6A；tests 322/322（t15 12/12）；**未合** / 未 npm |
| T16 | 端到端验收 | ⬜ | P3 |
...
| 日期 | 说明 |
|---|---|
| 2026-09-11 | T15 #62 r3 CLEAN @ `f8561bf`（r2 @ `b7d346b` stale；premature finish-work @ `5670f14` reverted）；GitNexus `lastCommit`=`f8561bf`；finish-work 待重做；**未合** |
