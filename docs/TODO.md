...
| **P2** | T9–T14 验证 / 移动端 | 🟡 T9 ✅ #49 → `314c345`；T10 ✅ #51 → `014f480`；T11 🟡 coding PR（未合）；T12–T14 未开 |
...
| T11 | `sbtd_bdd` | 🟡 | coding PR opened (scheme A); locks Q1C Q2B Q3A Q4A Q5A Q6A；未合 / 未 finish-work / 未 npm |
| T12 | Maestro 预检 | ⬜ |  |
| T13 | `sbtd_e2e` | ⬜ |  |
| T14 | `sbtd_lessons` | ⬜ |  |
...
| 日期 | 说明 |
|---|---|
| 2026-09-10 | T11 scheme A coding：`sbtd_bdd` + apply 注册 + tests；locks Q1C Q2B Q3A Q4A Q5A Q6A；未合 / 未 finish-work / 未 npm |
