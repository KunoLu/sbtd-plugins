...
|---|---|---|
| **P0** | T0–T3 骨架 + 硬门禁 | ✅ 完成 |
| **P1** | T4–T8 核心闭环 | 🟡 T4–T6 完成（T6 `4e76ae8`）；FU2 ✅；FU3 ✅ #43 scheme A；T7–T8 未开 |
| **P2** | T9–T14 验证 / 移动端 | ⬜ 未开 |
...
| FU3 | multi-fact matching-set + persist-across-replans | ✅ | [#43](https://github.com/KunoLu/sbtd-plugins/pull/43) scheme A finish；CLEAN r5；tip `bdc25f3` / prod `d2194f5`；tests 121/121；locks Q1D Q2B Q3A Q4B Q5A；archive `09-08-dsh-sbtd-fu3-multi-fact-persist`；merge SHA pending squash |
...
| 2 | **FU3** multi-fact 匹配集合 + persist-across-replans / mergeGate demote | ✅ #43 scheme A（merge SHA pending squash） |
| 3 | T7 Trellis 后端 | ⬜ |
