...
| T15 | `/sbtd` 命令与 README | 🟡 | `feat/t15-sbtd-command`；scheme A；locks Q1A–Q6A |
| T16 | 端到端验收 | ⬜ | P3 |
...
| 11 | **T15** `/sbtd` 命令与 README | 🟡 `feat/t15-sbtd-command` |
---
...
| 日期 | 说明 |
|---|---|
| 2026-09-11 | T15 开分支 `feat/t15-sbtd-command`：`/sbtd` 人类命令 + package README；locks Q1A–Q6A；未合 / 未 npm |
