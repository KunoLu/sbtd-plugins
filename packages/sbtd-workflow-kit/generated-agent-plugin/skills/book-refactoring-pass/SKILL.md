...
description: Guides behavior-preserving refactoring with small, reversible
  steps. Mandatory before the first implementation edit to existing production
  code; otherwise use on demand when structural friction, duplication, long
  functions, tangled responsibilities, or unsafe cleanup could affect the
  change.
license: Apache-2.0
allowed-tools: read grep glob bash
metadata:
  sbtd.category: refactoring
  sbtd.portable: "true"
  sbtd.source-revision: f8aa0d7225a26c5e00b81d2f1b05121108e63630
compatibility: Requires project tests; Trellis artifacts and GitNexus are
