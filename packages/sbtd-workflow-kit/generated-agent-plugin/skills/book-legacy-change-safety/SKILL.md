...
description: Guides safe changes to legacy or weakly tested code by
  characterizing behavior before editing. Mandatory before the first
  behavior-changing edit for existing-behavior bug fixes or existing code with
  unclear behavior, low coverage, hidden dependencies, or high regression risk;
  otherwise use on demand.
license: Apache-2.0
allowed-tools: read grep glob bash
metadata:
  sbtd.category: safety
  sbtd.portable: "true"
  sbtd.source-revision: 4222b15cc0e101bfe3489f1cebc0e5bfb4d1bddb
compatibility: Requires project characterization or safety-net tooling; Trellis
  and GitNexus are optional.
---
