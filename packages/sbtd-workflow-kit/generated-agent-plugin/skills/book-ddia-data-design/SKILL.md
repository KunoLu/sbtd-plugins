...
description: Guides data-intensive design checks for consistency, reliability,
  schema evolution, and data flow risks. Mandatory before design stabilizes or
  implementation begins when changing persisted/shared data, schemas,
  migrations, shared/persistent/cross-request/cross-process caches, async or
  cross-service flows, data ownership, or recovery; otherwise use on demand.
license: Apache-2.0
...
compatibility: Requires project architecture and data-flow evidence; migration
  tools, Trellis, GitNexus, and tests are optional.
---
