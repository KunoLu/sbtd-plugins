...
description: Use when configuring or running product-level Knowledge Ingest,
  target-ref Feature catalogs, Evidence Policy decisions, Revision Sets,
  idempotent smoke, or local/remote knowledge runners across repositories.
license: Apache-2.0
allowed-tools: read grep glob bash
metadata:
  sbtd.category: knowledge
  sbtd.portable: "true"
  sbtd.source-revision: f8aa0d7225a26c5e00b81d2f1b05121108e63630
compatibility: Requires Python 3.10+, PyYAML, jsonschema, and configured
  repositories or runner adapters.
---
