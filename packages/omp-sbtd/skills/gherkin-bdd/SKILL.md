---
name: gherkin-bdd
description: Use when adding, changing, reviewing, testing, synchronizing, or
  read-only ingesting user-visible behavior with BDD, Gherkin, Given/When/Then
  scenarios, .feature files, acceptance criteria, knowledge catalogs, or bug-fix
  behavior specs.
license: Apache-2.0
...
compatibility: Requires repository BDD conventions or a project test runner;
  Knowledge Ingest and Maestro are optional.
---
