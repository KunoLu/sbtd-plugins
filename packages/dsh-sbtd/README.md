...
`manuals/` 是从 `KunoLu/640-skills` v1.0.15（sourceRevision `bc8eec1549928fb0966254751b96b611b6334183`）只读同步的 skill 正文。每个 skill 只拷贝 `SKILL.md` 与该 skill 自己的 `references/`。不要手改 manuals 正文。
