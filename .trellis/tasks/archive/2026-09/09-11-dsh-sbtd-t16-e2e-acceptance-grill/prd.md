...
- **Q3A** — human `dsh web`.
- **Q4A** — `docs/assets/archive/dsh-sbtd-acceptance-t16.md` is the Acceptance Record (not a KPi Evidence Envelope).
...
- [x] T16 PASS all 8 steps recorded in `docs/assets/archive/dsh-sbtd-acceptance-t16.md`
...
- Fence: `docs/assets/archive/dsh-sbtd-acceptance-t16.md` + root `.gitignore` `*.tgz`. NO npm. NO product code.
